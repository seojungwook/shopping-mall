...
<c:if test="${countlist  == 0 }">
	...
	<c:if test="${countlist >0 }">
		...
		<tr>
			<td align="center">
				<a href="../dealboard/saleDetail.html?num=${zzim.bNo}&url=2&category=${zzim.category}"><img src="../file/${zzim.picture1}" height="100"></a>
			</td>
			<td align="left">
				<a href="../dealboard/saleDetail.html?num=${zzim.bNo}&url=2&category=${zzim.category}">${zzim.iname}</a>
			</td>
